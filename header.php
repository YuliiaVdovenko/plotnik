		...
		<nav class="row">
			...
			<div class="header-mobile-menu container-fluid hm-menu">
				...
				<div class="header-desktop-menu">
					<?php if( is_front_page() ){ ?>
					<div class="container-fluid pr-5 pt-5">
						<div class="row">
							<div class="container">
								<div class="row">
									<!-- ******************* navbar front page ******************* -->
									<!--************** The logo ***********************-->
									<div class="col-lg-6 front-page-logo">
										<!-- Your site title as branding in the menu -->
										<?php if ( ! has_custom_logo() ) { ?>
									...
									<div class="col-lg-6 right-header-block">
										<div class="row top-right-header-block pt-1">
											<div class="main-navbar col-6">							
												...
												<?php wp_nav_menu(
													array(
														...
														'container_class' => '',
														'container_id'    => '',
														'menu_class'      => 'header-navbar flex-column',
														'fallback_cb'     => '',
												...
												<div class="col-6 text-center go-to-help">
													<!--************* bottom help-project *************-->
													<a class="front-help-project" href="<?php echo esc_url( home_url( '/допомога-проекту' ) ); ?>">Допомога проекту</a>
												</div>
											</div>
